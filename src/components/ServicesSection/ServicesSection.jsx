...
import { FaSalesforce, FaCloud, FaUsers, FaBolt, FaLink, FaChartLine, FaArrowRight } from "react-icons/fa";
        ...
        <section className="services-v2">
            <div className="container">
                ...
                <motion.div className="svc-heading" {...fadeUp(0)}>
                    ...
                    <p>
                        We design, implement and optimize Salesforce solutions that streamline operations, automate processes and accelerate your digital
                        transformation.
                    </p>
                </motion.div>
                ...
                <div className="bento-grid">
                    {services.map((svc, i) => (
                        <motion.div key={svc.title} className={`svc-card ${svc.card}${svc.featured ? " featured" : ""}`} {...fadeUp(i * 0.1)}>
