...
import { FaMapMarkerAlt, FaEnvelope, FaPhoneAlt, FaPaperPlane, FaCertificate, FaBolt, FaShieldAlt } from "react-icons/fa";
        ...
        <form className="contact-form" onSubmit={handleSubmit} noValidate>
            <div className="form-row">
                <div className="form-field">
                    ...
                    <input id="name" name="name" type="text" placeholder="Jane Cooper" value={form.name} onChange={handleChange} />
                </div>
                <div className="form-field">
            ...
            {status === "success" && <p className="form-msg success">Thanks — your message is in. We'll get back to you shortly.</p>}

            <button className={`submit-btn ${status === "sending" ? "loading" : ""}`} type="submit" disabled={status === "sending"}>
                {status === "sending" ? (
                    <>
            ...
            <p className="form-fallback">
                Prefer email? Reach us directly at <a href={`mailto:${COMPANY_EMAIL}`}>{COMPANY_EMAIL}</a>
            </p>
        </form>
    );
}
    ...
    return (
        <div className="ca-contact">
            <Helmet>
                ...
                <meta property="og:title" content="Contact CloudAge Informatica" />
...
`}
            ...
            <section className="contact-hero">
                <div className="container contact-hero-inner">
                    <motion.span className="pill-tag" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                        CONTACT US
                    </motion.span>
                    ...
                    <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.15 }}>
                        Whether you need Salesforce consulting, custom development, Experience Cloud, integrations or long-term support, we're here to help your
                        business grow.
                    </motion.p>
            ...
            <section className="global-reach">
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <p>
                            From startups to enterprises, CloudAge Informatica partners with organizations worldwide. No matter where you're located, our experts
