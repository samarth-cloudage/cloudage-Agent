...
const certificateImages = import.meta.glob("../assets/certificates/*.png", {
    eager: true,
    import: "default",
});
    ...
    return (
        <div className="ca-services-blue">
            <Helmet>
                ...
                <meta property="og:title" content="Salesforce Services | CloudAge Informatica" />
...
`}
            ...
            <section className="aboutHero">
                <div className="container aboutHeroGrid">
                    ...
                    >
                        ...
                        <p>
                            CloudAge Informatica is a Salesforce consulting company helping startups and enterprises simplify business operations through CRM
                            implementation, Experience Cloud, custom development, automation and integrations.
                        </p>
            ...
            <section className="pillars">
                <div className="container">
                    <motion.div className="section-title" {...fadeUp()}>
                        ...
                        <p>We don't spread thin across everything — we go deep on Salesforce and web app development, so both stay genuinely excellent.</p>
                    </motion.div>

                    <div className="pillar-grid">
                        {pillars.map((p, i) => (
                            <motion.a href={p.anchor} className="pillar-card" key={p.title} {...fadeUp(0.1 * i)}>
            ...
            <section className="service-block" id="salesforce">
                <div className="container">
                    <motion.div className="section-title" {...fadeUp()}>
                        ...
                        <p>Consider us your Salesforce consulting partner — from first implementation to the migration that finally moves you to Lightning.</p>
                    </motion.div>
            ...
            <section className="certificate-section">
                ...
                <div className="container">
                    ...
                    >
                        <button className="cert-nav-btn" onClick={() => certSwiper?.slidePrev()} aria-label="Previous certificate">
                            <FaArrowLeft />
                        </button>
                        ...
                        <button className="cert-nav-btn" onClick={() => certSwiper?.slideNext()} aria-label="Next certificate">
                            <FaArrowRight />
                        </button>
                    </motion.div>
                </div>
            ...
            <section className="faq-toggle-section">
                <div className="container">
                    ...
                    >
                        ...
                        <motion.span className="faq-toggle-icon" animate={{ rotate: faqOpen ? 180 : 0 }} transition={{ duration: 0.3, ease: "easeOut" }}>
                            <FaChevronDown />
                        </motion.span>
                    </motion.button>
                        ...
                        {faqOpen && (
                            ...
                            >
                                <div className="section-title faq-panel-title">
                                    ...
                                    <p>Answers to some of the most common questions about our Salesforce services.</p>
                                </div>
                                    ...
                                    {salesforceFaqs.map((f, i) => {
                                        ...
                                        return (
                                            <div className={`faq-item${isOpen ? " open" : ""}`} key={f.q}>
                                                <button type="button" className="faq-question" onClick={() => setOpenFaq(isOpen ? -1 : i)} aria-expanded={isOpen}>
                                                    <h3>{f.q}</h3>
                                                    <motion.span className="faq-icon" animate={{ rotate: isOpen ? 180 : 0 }} transition={{ duration: 0.3, ease: "easeOut" }}>
                                                        <FaChevronDown />
                                                    </motion.span>
                                                </button>
            ...
            <section className="service-block alt" id="webapp">
                <div className="container">
                    <motion.div className="section-title" {...fadeUp()}>
                        ...
                        <p>Design and engineering under one roof, so nothing gets lost in translation between how it looks and how it works.</p>
                    </motion.div>
            ...
            <section className="closing-cta">
                ...
                <div className="container cta-inner">
                    <motion.div className="cta-copy" {...fadeUp()}>
                        ...
                        <p>
                            Whether it's a Salesforce org that's fighting you or a website that isn't converting, tell us where it hurts. We'll take it from there.
                        </p>
