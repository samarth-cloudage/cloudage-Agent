    ...
    return (
        <div className="ca-about-blue">
            <Helmet>
                ...
                <meta property="og:title" content="About CloudAge Informatica | Salesforce Experts" />
...
`}
            ...
            <section className="hero">
                ...
                <div className="container hero-grid">
                    <motion.div className="hero-copy" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
                        <span className="pill-tag">ABOUT CLOUDAGE</span>

                        <h1>
                            Provide The Best <span>Salesforce Solutions</span> To Grow Your Business
                        </h1>

                        <p className="hero-lead">
                            We are a team of certified Salesforce experts who simplify operations, automate the busywork, and build systems your team will actually
                            enjoy using.
                        </p>

                        <p className="hero-sub">
                            If you're looking for a partner who designs, builds and supports your org end-to-end, you're in the right place. We work as an extension
                            of your team — not a vendor you only call when something breaks.
                        </p>
            ...
            <section className="mission">
                <div className="container">
                    <motion.div className="section-title" {...fadeUp()}>
                        ...
                        <p>Everything we build is focused on delivering measurable business value through innovation, trust and long-term partnerships.</p>
                    </motion.div>
                    ...
                    <div className="tilt-grid">
                        <motion.div className="tilt-card" {...fadeUp(0.05)}>
                            ...
                            <h3>Mission</h3>
                            <p>
                                To help Salesforce customers of every size automate and simplify their business processes — turning the platform into a productivity
                                engine that saves time and drives measurable outcomes.
                            </p>
                        </motion.div>
                        ...
                        <motion.div className="tilt-card" {...fadeUp(0.15)}>
                            ...
                            <h3>Vision</h3>
                            <p>
                                To be a globally trusted Salesforce implementation partner, known for deep platform expertise, transparent delivery, and long-term
                        ...
                        <motion.div className="tilt-card" {...fadeUp(0.25)}>
                            ...
                            <h3>Core Values</h3>
                            <p>Transparency, sharp engineering and outcomes clients can point to — nothing performative.</p>
                        </motion.div>
                    </div>
                </div>
            </section>
            ...
            <section className="marquee-section">
                ...
                <div className="marquee-row">
                    <div className="marquee-track track-right">
                        {[...testimonials.slice().reverse(), ...testimonials.slice().reverse()].map((line, i) => (
            ...
            <section className="industries">
                <div className="container">
                    <motion.div className="section-title" {...fadeUp()}>
                        ...
                        <p>Our Salesforce implementations flex to fit businesses of every size, across the industries below.</p>
                    </motion.div>
            ...
            <section className="closing-cta">
                ...
                <div className="container cta-inner">
                    <motion.div {...fadeUp()}>
                        ...
                        <p>
                            Your success isn't just a goal for us — it's a commitment. We work as your extended team: strategizing, building and supporting the
                            systems that take your business further.
                        </p>
